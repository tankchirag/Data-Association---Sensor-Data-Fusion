    ...
    def process_pcd_files(self, pcd_file):
        ...
        if pcd_np.shape[0] > 0:
            ...
            for cluster in df["cluster"].unique():
                ...
                centroid_closest_point_closest_point_velocity = [centroid, closest_point_position, closest_point_velocity]
                file_info['cluster'].append(centroid_closest_point_closest_point_velocity)
